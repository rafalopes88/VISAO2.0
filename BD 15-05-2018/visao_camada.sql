...
CREATE TABLE `camada` (
  `cod_Camada` int(11) NOT NULL AUTO_INCREMENT,
  `nome` varchar(45) DEFAULT NULL,
  `descricao` varchar(45) DEFAULT NULL,
  `usuario_cod_usuario` int(11) NOT NULL,
  `base` tinyint(1) DEFAULT NULL,
  PRIMARY KEY (`cod_Camada`),
  KEY `fk_Camada_usuario1_idx` (`usuario_cod_usuario`),
  CONSTRAINT `fk_Camada_usuario1` FOREIGN KEY (`usuario_cod_usuario`) REFERENCES `usuario` (`cod_usuario`) ON DELETE NO ACTION ON UPDATE NO ACTION
